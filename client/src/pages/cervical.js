          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <Button  value='https://www.instagram.com/p/ByShUDZpKRe'
                  onClick ={this.handleSubmit}>Favorite</Button>
              </p>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <Button  value='https://www.instagram.com/p/ByiRqe9BlqW'
                  onClick ={this.handleSubmit}>Favorite</Button>
              </p>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <Button  value='https://www.instagram.com/p/B8ti583gwuZ'
                  onClick ={this.handleSubmit}>Favorite</Button>
              </p>
            </div>
            <div className="col-lg-6">
