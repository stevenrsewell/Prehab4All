          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                <br></br>
                <InstagramEmbed
                  url='https://www.instagram.com/tv/B835m7mnsTQ'
                  maxWidth={320}
                  hideCaption={true}
            ...
            <div className="col-lg-6">
              ...
              <div className="row" font="bold">
                <br></br>
                <h4>Dr. Caleb Burgess DPT OCS CSCS</h4>
              </div>
              <div className="row" font="bold">
          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <br></br>
                <InstagramEmbed
                  url='https://www.instagram.com/tv/ByShUDZpKRe'
                  maxWidth={320}
                  hideCaption={true}
                  containerTagName='div'
                  protocol=''
          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <br></br>
                <InstagramEmbed
                  url='https://www.instagram.com/tv/ByiRqe9BlqW'
                  maxWidth={320}
                  hideCaption={true}
                  containerTagName='div'
                  protocol=''
          ...
          <div className="row">
            <div className="col-lg-6">
              <p>
                ...
                <br></br>
                <InstagramEmbed
                  url='https://www.instagram.com/tv/B8ti583gwuZ'
                  maxWidth={320}
                  hideCaption={true}
                  containerTagName='div'
                  protocol=''
